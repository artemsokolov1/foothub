...
const COPY = {
  ...
  hockey: {
    ...
    title: "Хоккей",
    accent: "сегодня",
    lead: "Матчи дня и экспресс по клубам КХЛ. Ставку собирай в Телеграме.",
    empty: "Хоккейных матчей и экспресса на сегодня пока нет. Как появятся на stavka — страница обновится сама.",
  },
  esports: {
    badge: "CS2 и Dota",
    title: "Киберспорт",
    accent: "сегодня",
    lead: "Топовые матчи дня и экспресс, если он вышел. Ставку собирай в Телеграме.",
    empty: "Киберматчей на сегодня пока нет. Как появятся на stavka — страница обновится сама.",
  },
};
